...
8. Go back to the original terminal that points to the CIS-4375-Team-06-Spring-2025 folder path. Run the command "node server.js" to launch the server.
